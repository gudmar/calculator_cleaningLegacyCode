/* bugs:
1) No ability to make 0/1 or 0-1  - no possibility to start from 0
2) No negative numbers ->  -1+2 will not work (NaN is result) (-2)+1 will also not work
OK 3) 3//6 gives NaN - not error message
4) 4()9 gives 9 - not error message
OK 5) 4 )(9 gives s - not eror message
6) 3.3.3 gives 3.3.3 -> not an error, however it is cought by finalResult function :) and gives 1.


//http://scanftree.com/Data_Structure/infix-to-prefix

// LINE 137 BUG MISUNDERSTANDING   inLst == 4, where inputList == '$' + content - so unshift changes original list !!!! 
